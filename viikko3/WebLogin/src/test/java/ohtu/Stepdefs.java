...
public class Stepdefs {
    ...
    public void invalidUserTriedToBeCreated(String username, String password) {
        registerIsSelected();
        registerWith(username, password, password);
    }
    ...
    public void tooShortUsernameAndValidPassword(String username, String password) {
        registerWith(username, password, password);
    }
    ...
    @When("valid username {string} and password {string} and unmatching password confirmation are entered")
    public void validUsernameAndValidPasswordAndUnmatchingConfirmation(String username, String password) {
        registerWith(username, password, "randomtext");
    }
